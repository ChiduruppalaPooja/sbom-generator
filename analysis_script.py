...
def analyze_project(repo_owner, repo_name):
    ...
    for manifest_file_name, manifest_path in potential_manifests:
        manifest_path = get_manifest_file_path(repo_owner, repo_name, manifest_file_name)
        ...
        if manifest_path:
            ...
            if "package.json" in manifest_path:
                project_type = "nodejs"
            elif "requirements.txt" in manifest_path:
                project_type = "python"
            elif "pom.xml" in manifest_path:
                project_type = "java"
...
if __name__ == "__main__":
    ...
    analyze_project(repo_owner, repo_name)import requests
