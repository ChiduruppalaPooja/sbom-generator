    ...
    if composer_json_content:
        try:
            ...
            if 'require' in composer_data:
                ...
                dependencies_list = [{"name": name, "version": version, "platform": composer_data.get('config', {}).get('platform', 'php')} for name, version in dependencies.items()]
                result = {'dependencies': dependencies_list}
            else:
...
#             if 'require' in composer_data:
#                 dependencies = composer_data['require']
#                 dependencies_list = [{"name": name, "version": version, "platform": composer_data.get('config', {}).get('platform', '')} for name, version in dependencies.items()]
#                 result = {'dependencies': dependencies_list}
#             else:
#                 result = {'message': "No dependencies found in composer.json."}
...
#             if 'require' in composer_data:
#                 dependencies = composer_data['require']
#                 dependencies_list = [{"name": name, "version": version} for name, version in dependencies.items()]
#                 result = {'dependencies': dependencies_list}
#             else:
#                 result = {'message': "No dependencies found in composer.json."}
